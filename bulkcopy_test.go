...
func TestBulkcopy(t *testing.T) {
	...
	testValues := []testValue{
		...
		{"test_bit", true},
		{"test_bitn", nil},
		{"test_smalldatetime", time.Date(2010, 11, 12, 13, 14, 0, 0, Location)},
		{"test_smalldatetimen", time.Date(2010, 11, 12, 13, 14, 0, 0, Location)},
		{"test_datetime", time.Date(2010, 11, 12, 13, 14, 15, 120000000, Location)},
		{"test_datetimen", time.Date(2010, 11, 12, 13, 14, 15, 120000000, Location)},
		{"test_datetimen_1", time.Date(4010, 11, 12, 13, 14, 15, 120000000, Location)},
		{"test_datetime2_1", time.Date(2010, 11, 12, 13, 14, 15, 0, Location)},
		{"test_datetime2_3", time.Date(2010, 11, 12, 13, 14, 15, 123000000, Location)},
		{"test_datetime2_7", time.Date(2010, 11, 12, 13, 14, 15, 123000000, Location)},
		{"test_date", time.Date(2010, 11, 12, 00, 00, 00, 0, Location)},
		{"test_tinyint", 255},
		{"test_smallint", 32767},
		{"test_smallintn", nil},
		{"test_int", 2147483647},
